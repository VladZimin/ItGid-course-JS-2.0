...
function f6() {
    let arr = []
    for (const elem of a6) {
        for (const number of elem) {
            arr.push(number)
        }
    }
    out6.textContent = arr.join(' ')
}
