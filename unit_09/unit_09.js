...
let arrP = document.querySelectorAll('.p-6')
function f6() {
    out6.textContent = `${arrP.length}`
}
...
function f18() {
    out18.textContent = elem.getAttribute('data-b')
}
...
let elems = document.querySelectorAll('.p-19')
function f19() {
    let out = ''
    for (let i = 0; i < elems.length; i++) {
        out += elems[i].getAttribute('data-b') + ' '
    }
