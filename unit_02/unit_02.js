...
function t10() {
    ...
    document.querySelector('.out-10').innerHTML = data.value * 20;
    data.value = '';
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = data.value + 55;
    data.value = '';
}
...
function t12() {
    ...
    document.querySelector('.out-12').innerHTML = 'Hello ' + inp1.value + ' ' + inp2.value;
