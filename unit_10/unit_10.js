...
let ar6 = ['Vladislav','Aquarius',10,2]
...
function f16() {
    ...
    outOdd.textContent = odd
    outEven.textContent = even
    console.log(ar16_even, ar16_odd)
}
