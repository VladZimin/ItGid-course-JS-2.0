...
let oper = document.querySelector('.s-143')
let out14 = document.querySelector('.out-14')
let inp1 = document.querySelector('.i-141')
let inp2 = document.querySelector('.i-142')
...
let sel1 = document.querySelector('.s-151')
let sel2 = document.querySelector('.s-152')
let sel3 = document.querySelector('.s-153')
let out15 = document.querySelector('.out-15')

function f15(){
    let num1 = parseInt(sel1.value)
    let num2 = parseInt(sel2.value)

    switch (sel3.value) {
        case '&&': {
            out15.innerHTML = num1 && num2
            break
        }
        case '||': {
            out15.innerHTML = num1 || num2
