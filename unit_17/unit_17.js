...
function t5() {
    a5_res = a5.filter(elem => elem % 2 === 0 && typeof elem === 'number')
    return a5_res
}
...
function t8() {
    a8.map((elem, i) => elem % 2 === 0 && a8_res.push(i))
    return a8_res
}
...
function t9() {
    let arr = []
    a9.forEach( elem => arr.push(elem.toLowerCase()))
...
function t11() {
    a11_res = a11.filter((elem, i) => i % 2 === 0)
    return a11_res
...
function t14() {
    let arr = a14.map(elem => elem.toLowerCase())
