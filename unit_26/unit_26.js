...
function t1() {
    fetch(`${param.url}?auth=${param.key}&action=1`)
...
function t2() {
    fetch(`${param.url}?auth=${param.key}&action=2&name=Vlad`)
        .then(response => response.text())
...
function t3() {
    fetch(`${param.url}?auth=${param.key}&action=3&num1=5&num2=15`)
        .then(response => response.text())
...
function t4() {
    fetch(`${param.url}?auth=${param.key}&action=4&num1=5&num2=11`)
        .then(response => response.text())
...
function t5() {
    fetch(`${param.url}?auth=${param.key}&action=5`)
        .then(response => response.text())
...
function t6() {
    fetch(`${param.url}?auth=${param.key}&action=6&num1=5&num2=11`)
        .then(response => response.text())
...
function t7() {
    fetch(`${param.url}?auth=${param.key}&action=7`)
        .then(response => response.text())
        .then(data => document.querySelector('.out-7').innerHTML = `<a>${data}</a>`)
}
...
function t8() {
    fetch(`${param.url}?auth=${param.key}&action=8&year=1997`)
        .then(response => response.text())
...
function t9() {
    fetch(`${param.url}?auth=${param.key}&action=9&m=1&d=1&y=1`)
        .then(response => response.text())
...
function t11() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=2&name=Vlad`
    })
        .then(response => response.text())
...
function t12() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=3&num1=17&num2=13`
    })
        .then(response => response.text())
...
function t13() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=4&num1=10&num2=15`
    })
        .then(response => response.text())
...
function t15() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=6&num1=777&num2=888`
    })
        .then(response => response.text())
...
function t16() {
    fetch(param.url, {
        ...
        .then(response => response.text())
        .then(data => document.querySelector('.out-16').innerHTML = `<a>${data}</a>`)
}
...
function t17() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=8&year=1998`
    })
        .then(response => response.text())
...
function t18() {
    fetch(param.url, {
        ...
        body: `auth=${param.key}&action=9&m=1&d=1&y=1`
    })
        .then(response => response.text())
